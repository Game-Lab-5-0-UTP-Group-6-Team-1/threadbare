...
class_name Projectile_elementals
extends RigidBody2D
...
func _on_body_entered(body: Node2D) -> void:
	...
	# --- Si choca con el jugador Jozu ---
	if can_hit_player and body.is_in_group("jozu"):
		if body.has_method("take_damage"):
			body.take_damage(1)  # resta medio corazón
			print("¡Jozu recibió daño del proyectil!")
		queue_free()
